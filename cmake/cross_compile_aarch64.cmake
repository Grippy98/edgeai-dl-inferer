...
if (NOT DEFINED ENV{TENSORFLOW_INSTALL_DIR})
    message(FATAL_ERROR "TENSORFLOW_INSTALL_DIR not defined.")
endif()

if (NOT DEFINED ENV{ONNXRT_INSTALL_DIR})
    message(FATAL_ERROR "ONNXRT_INSTALL_DIR not defined.")
endif()

if (NOT DEFINED ENV{DLPACK_INSTALL_DIR})
    message(FATAL_ERROR "DLPACK_INSTALL_DIR not defined.")
endif()
